...
public class OrderablePropertysetItem implements Item, Item.PropertySetChangeNotifier,
        Cloneable {
    ...
    private void fireItemPropertySetChange() {
        if (propertySetChangeListeners != null) {
            ...
            final Item.PropertySetChangeEvent event = new OrderablePropertysetItem.PropertySetChangeEvent(
                    this);
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        final OrderablePropertysetItem npsi = new OrderablePropertysetItem();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof OrderablePropertysetItem)) {
            return false;
        }

        final OrderablePropertysetItem other = (OrderablePropertysetItem) obj;
    ...
    public int getPropertyIdIndex(Object id) {
        return list.indexOf(id);
    }

    public void movePropertyId(Object id, int newIndex) {
        list.remove(id);
        list.add(newIndex, id);
    }
}
