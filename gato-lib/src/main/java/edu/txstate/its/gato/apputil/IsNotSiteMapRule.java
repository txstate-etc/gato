...
public class IsNotSiteMapRule extends AbstractAvailabilityRule {

    private static final Logger log = LoggerFactory.getLogger(IsNotSiteMapRule.class);
    
    public static final String[] TEMPLATE_IDS_SITEMAP = {"gato-template-txstate2015:pages/sitemap", 
                                                        "gato-template-mobilefirst:pages/sitemap"};
        ...
        if (itemId instanceof JcrItemId && !(itemId instanceof JcrPropertyItemId)) {
            ...
            if (node != null) {
                try {
                    ...
                    return !(ArrayUtils.contains(TEMPLATE_IDS_SITEMAP, template));
