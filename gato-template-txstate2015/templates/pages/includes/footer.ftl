...
<div class="footer row">
	<div class="footer_content eq-parent">
		...
		<div class="column eq-mn-1-3 footer_column footer_column_1">
			[@cms.area name="siteinfo" content=gf.getOrCreateArea(homepage, 'siteinfo') editable=isHomePage/]
		</div>
		<div class="column eq-mn-1-3 footer_column footer_column_2" >
			<div class="txst_logo">
		...
		<div class="column eq-mn-1-3 footer_column footer_column_3">
