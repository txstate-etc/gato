    ...
    [#list model.getPeople(content.department) as person]
        ...
        [#if showRecord]
            <div class="txst-departmentdirectory-entry vcard row clearfix eq-parent">
                <div class="txst-departmentdirectory-name fn n eq-md-1-1 eq-xs-1-1 eq-mn-1-1">
                ...
                <div class="txst-departmentdirectory-title eq-md-1-2 eq-xs-1-1 eq-mn-1-1">
                    ${person.title} 
                    &nbsp;
                </div><div class="txst-departmentdirectory-address street-address eq-md-1-2 eq-xs-1-1 eq-mn-1-1">
                    ${person.address}
                    &nbsp;
                </div> 
                 <div class="txst-departmentdirectory-phone tel eq-md-1-2 eq-xs-1-1 eq-mn-1-1">
                 <span class="dd-icon"><i class="fa fa-phone"></i></span>
                    ${person.phone} 
                    &nbsp;
                </div><div class="txst-departmentdirectory-email email eq-md-1-2 eq-xs-1-1 eq-mn-1-1">
