...
<div class="gato-card gato-card-video eq-parent ${gf.jsonGetString(oembed, 'provider_name')?lower_case} ${ctx.cardsize} ${content.color!'color1'}" data-tags="${gf.toJSON(gf.getTags(content))?html}">
  <figure>
