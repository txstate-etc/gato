...
})(window,document,'script','dataLayer','${globalData.tagmanager.global_account}');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=${globalData.tagmanager.global_account}"
