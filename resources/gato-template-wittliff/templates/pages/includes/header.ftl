<header class="page-header">
  ...
  <a href="http://www.txst.edu" class="texas-state"><img src="${gf.resourcePath()}/gato-template-wittliff/images/txst-logo.svg" alt="Texas State University"></a>
  ...
  <div class="main-menu">
    ...
    <nav id="main-menu-panel" class="main-menu-panel" role="navigation">
      ...
      [/#if]
      <a href="http://www.txst.edu"><img src="${gf.resourcePath()}/gato-template-wittliff/images/txst-logo.svg" class="menu-txst-logo" alt="Texas State University"></a>
    </nav>
  </div>
</header>
