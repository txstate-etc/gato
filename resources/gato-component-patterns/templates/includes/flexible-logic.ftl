...
[#function rowHasWide components]
    ...
    [#return false]
[/#function]
[#function hasSameWidth componentA componentB]
  [#if componentA.isWide?has_content && componentA.isWide]
    [#return (componentB.isWide?has_content && componentB.isWide)]
  [#else]
    [#return !(componentB.isWide?has_content && componentB.isWide)]
  [/#if]
[/#function]
