        ...
        <div class="eq-mn-1-1 eq-ml-1-3">
          <div class="pres-updates col-right">
            <div class="pres-updates-content">
              <h3>Updates</h3>
              <ul>
                <li>Next open door with President Trauth is on November 12, 2015. All students are invited. <a href="#nowhere">RSVP here</a>.</li>
                <li>Fall Convocation 2015 was a great success. <a href="#nowhere">Read the speech</a>.</li>
              </ul>
            </div>
          </div>
        </div>
