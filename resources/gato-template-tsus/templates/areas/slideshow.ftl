...
<div class="slides">
  [#list components as slide]
    [@cms.component content=slide contextAttributes={"index": slide_index, "slideactive": (slide_index == 0)?string("slideactive", "")} editable=false /]
  [/#list]
</div>
<ul class="pages">
  <li class="prev"><a href="#">&nbsp;</a></li>
  [#list components as slide]
    [#assign slideactive=(slide_index == 0)?string("slideactive", "")]
